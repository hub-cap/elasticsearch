...
public abstract class InputResult implements ToXContentObject {
    ...
    protected InputResult(String type, Payload payload) {
    ...
    protected InputResult(String type, Exception e) {
