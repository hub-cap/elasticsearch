...
public abstract class TransformResult implements ToXContentObject {
    ...
    public TransformResult(String type, Payload payload) {
        this.type = type;
    ...
    public TransformResult(String type, String reason) {
        this.type = type;
    ...
    public TransformResult(String type, Exception e) {
        this.type = type;
        this.status = Status.FAILURE;
