...
public class ConditionResult implements ToXContentObject { // don't make this final - we can't mock final classes :(
    ...
    public ConditionResult(Map<String, Object> resolveValues, String type, boolean met) {
