...
public abstract class ActionResult implements ToXContentFragment {
    ...
    protected ActionResult(String type, Status status) {
        this.type = type;
        this.status = status;
    }
    ...
    /**
     * {@code StoppedResult} is a {@link ActionResult} with a {@link #reason()}.
     * <p>
     * Any {@code StoppedResult} should provide a reason <em>why</em> it is stopped.
     */
    public static class StoppedResult extends ActionResult {
    ...
    public static class FailureWithException extends ActionResult {
