...
public final class SnapshotClient {
    ...
    public PutRepositoryResponse putRepository(PutRepositoryRequest putRepositoryRequest, Header... headers) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(putRepositoryRequest, RequestConverters::putRepositories,
    ...
    public void putRepositoryAsync(PutRepositoryRequest putRepositoryRequest,
        ...
        restHighLevelClient.performRequestAsyncAndParseEntity(putRepositoryRequest, RequestConverters::putRepositories,
