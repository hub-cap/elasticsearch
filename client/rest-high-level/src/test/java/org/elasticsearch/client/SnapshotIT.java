...
public class SnapshotIT extends ESRestHighLevelClientTestCase {
    ...
    public void testCreateRepository() throws IOException {
        PutRepositoryResponse response = createTestRepository("test", "fs", "{\"location\": \".\"}");
        assertTrue(response.isAcknowledged());
    }

    public void testModulesGetRepositoriesUsingParams() throws IOException {
        String testRepository = "test";
        assertTrue(createTestRepository(testRepository, "fs", "{\"location\": \".\"}").isAcknowledged());
        assertTrue(createTestRepository("other", "fs", "{\"location\": \".\"}").isAcknowledged());
    ...
    public void testModulesGetDefaultRepositories() throws IOException {
        assertTrue(createTestRepository("other", "fs", "{\"location\": \".\"}").isAcknowledged());
        assertTrue(createTestRepository("test", "fs", "{\"location\": \".\"}").isAcknowledged());
